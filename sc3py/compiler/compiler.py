...
with open("/compiler/conf/sc3.mapping.json") as f: #if you are mac, /Users/username/xxx/sc3py/sc3py/compiler/conf/sc3.mapping.json
...
def parse_sprite(sprite, res_file):
    """
    Parse a Sprite.
...
def main():
    ...
    with open("/compiler/source/project.json", encoding="utf-8") as f: #mac:/Users/xxx/xxx/sc3py/sc3py/compiler/source/project.json
        j = json.load(f)
    ...
    # write import
    with open("/compiler/result/main.py", "w", encoding="utf-8") as res_file: #/Users/xxx/xxx/sc3py/sc3py/compiler/result/main.py
        res_file.write(
            "import threading\nimport scgame\ngame={}\n\n"
        )  # import + `game={}`(just avoiding errors)
        print(list(sprites.keys()))
        for sprite_name in ["motion", "looks", "sound", "events", "control"]:
            if sprite_name in sprites:
                parse_sprite(sprites[sprite_name], res_file)
